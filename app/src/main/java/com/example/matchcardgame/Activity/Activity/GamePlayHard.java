...
public class GamePlayHard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_play_hard);
        ...
        if (type.equals("animal") & levelSelect.equals("hard")) {
            adapter = new ImageAdapter(this, true, "animal", "hard");
        } else if (type.equals("emoji") & levelSelect.equals("hard")) {
            adapter = new ImageAdapter(this, true, "emoji", "hard");
        }
...
//                        points.setText(Integer.toString(pointCounter));
    ...
    private void showWonDialog(int gravity) {
        ...
        if(getIntShare(KEY_HIGH_SOCCER_HARD)<diem){
            putIntShare(KEY_HIGH_SOCCER_HARD,diem);
        }
        timePlayIv.setText(""+(240-diem)+" Seconds");
...
//        }
    ...
    private void timeCountHard() {

        long duration = TimeUnit.MINUTES.toMillis(4);
